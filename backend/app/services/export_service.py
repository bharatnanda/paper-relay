...
class ExportService:
    ...
    def generate_pdf(
        ...
        if summary:
            ...
            self._append_pdf_section(story, styles, "Bottom Line Verdict", summary.bottom_line_verdict)
    ...
    def generate_markdown(
        ...
        if summary:
            ...
            self._append_markdown_section(lines, "Bottom Line Verdict", summary.bottom_line_verdict)
